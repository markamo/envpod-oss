...
Copyright 2026 Xtellix Inc. Licensed under the Apache License, Version 2.0.
...
README_EOF
   ...
   1. Definitions.
      ...
      License, as indicated by a copyright notice included in or attached
      to the work.

      "Derivative Works" shall mean any work, in Source or Object form,
   ...
   4. Redistribution. You may reproduce and distribute copies of the
      ...
      (d) If the Work includes a "NOTICE" text file as part of its
          ...
          notices in at least one of the following places: within a NOTICE
          text file distributed as part of the Derivative Works; within the
          Source form or documentation; or within a display generated by
   ...
   8. Limitation of Liability. In no event and under no legal theory,
      ...
      indirect, special, incidental, or exemplary, or consequential damages
      of any character arising as a result of this License or out of the
      use or inability to use the Work, even if such Contributor has been
