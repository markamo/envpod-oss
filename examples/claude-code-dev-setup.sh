...
echo "    sudo envpod run $POD_NAME -- claude"
echo ""
echo "  After work:"
echo "    sudo envpod diff $POD_NAME"
echo "    sudo envpod commit $POD_NAME src/"
echo "    sudo envpod rollback $POD_NAME"
echo ""
echo "  Your host profiles (git, gh, claude, ssh) are available inside the pod."
echo "  All changes are COW-isolated. Nothing touches your host until you commit."
